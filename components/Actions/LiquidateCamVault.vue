<template>
    <b-modal id="liquidateCamVault" @ok="execute" >
            <form @submit="execute">
               <b-form-group
    ...
    export default {
        ...
        data(){
            return {
                ...
                data:{
                    ...
                    vaultIDInput: "",
                    addressInput: "",
                    description: "Liquidate Vault To MAI (CAM Vault)",
                    tokenData: {
                        name:"",
                        symbol:""
                    },
        ...
        methods: {
            ...
            async execute(){
                ...
                this.requestMAIloan("quick_mai_usdt", new BigNumber(vaultDebt).dividedBy(new BigNumber(10).pow(18)).toFormat(2, BigNumber.ROUND_UP));
                ...
                var minMAIExpected = withdrawableCollateral.multipliedBy(MAIPerToken).multipliedBy(0.98).integerValue(BigNumber.ROUND_DOWN);
