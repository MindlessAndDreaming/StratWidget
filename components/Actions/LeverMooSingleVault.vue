    ...
    export default {
        ...
        methods: {
            ...
            async execute(){
                ...
                var amountToBorrow = loanValue.multipliedBy(1000).dividedToIntegerBy(994).minus(backing); // borrow fee plus buffer - amount to borrow from the vault at the end of the transaction
                ...
                await this.callTokenToMooToken(
                    minBaseCollateralIn,
